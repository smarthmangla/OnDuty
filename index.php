      ...
      <div class="left">
        ...
        <div id="details-container">
          <div class="bribery details">
            <p class="text"><br><?php
                                $sql = "SELECT * FROM `newsfeed` WHERE Crime_Name='Bribery'";
                                $result = mysqli_query($con, $sql);
                                $num = mysqli_num_rows($result);
                                echo $num;
        ...
        <div id="details-container">
          <div class="custodial details">
            <p class="text"><br><?php
                                $sql = "SELECT * FROM `newsfeed` WHERE Crime_Name='Custodial'";
                                $result = mysqli_query($con, $sql);
                                $num = mysqli_num_rows($result);
                                echo $num;
        ...
        <div class="columne1">
          <div class="carde1">
            ...
            <div class="containere1">
              <h2>Smarth Mangla</h2>
              <p>19BIT0329</p>
              <p class="titlee1">FrontEnd and Backend Developer </p>
            </div>
          </div>
        </div>
        <div class="columne1">
